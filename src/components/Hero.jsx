        ...
        <div className={`${styles.flexStart} flex-1 flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            <div className="flex flex-row justify-between items-center w-full">
                <h1 className="flex-1 font-poppins font-semibold 
                    ss:text-[57px] text-white ss:leading-[100px] leading-[75px]">
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
                Our team of experts use methodology to identify the credit card
                most likely to fit your needs. We examine annual precentage
                rates, annual fees.
            </p>
        </div>
